 ...
 * @author moises
 */
public class JanelaRemover extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaRemover.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
